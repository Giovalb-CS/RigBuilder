...
export default function SelectablePart({ part }) {
  ...
  const handleSelectPSU = (part) => {
    EventEmitter.emit("psuSelected", part);
    router.back();
  };
    ...
    <View style={styles.part}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.partText}>{part.type}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Efficiency</Text>
          <Text style={styles.partText}>{part.efficiency}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Wattage</Text>
          <Text style={styles.partText}>{part.wattage}W</Text>
        </View>
        <View style={styles.infoContainer}>
