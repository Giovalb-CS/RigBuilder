...
export default function SelectablePart({ part }) {
  ...
  const handleSelectSSD = (part) => {
    EventEmitter.emit("ssdSelected", part);
    router.back();
  };
  ...
  return (
    <View style={styles.part}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.label}>PCIe gen</Text>
          <Text style={styles.partText}>{part.pcie_gen}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Capacity</Text>
          <Text style={styles.partText}>{part.capacity}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Speed read</Text>
          <Text style={styles.partText}>{part.speed_read}MB/s</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Speed write</Text>
          <Text style={styles.partText}>{part.speed_write}MB/s</Text>
        </View>
      </View>
    </View>
  );
