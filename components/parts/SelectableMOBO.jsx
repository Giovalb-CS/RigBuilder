...
export default function SelectablePart({ part }) {
  ...
  const handleSelectMOBO = (part) => {
    EventEmitter.emit("moboSelected", part);
    router.back();
  };
    ...
    <View style={styles.part}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.partText}>{part.chipset}</Text>
        </View>
        <View style={styles.infoContainer}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.label}>RAM max speed</Text>
          <Text style={styles.partText}>{part.ram_max_speed}MHz</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>RAM slots</Text>
          <Text style={styles.partText}>{part.ram_slot}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>RAM max capacity</Text>
          <Text style={styles.partText}>{part.ram_max}GB</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>PCIe x16 slots</Text>
          <Text style={styles.partText}>{part.pcie_x16_slot}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>PCIe x1 slots</Text>
          <Text style={styles.partText}>{part.pcie_x1_slot}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>M.2 slots</Text>
          <Text style={styles.partText}>{part.m2_slot}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>SATA slots</Text>
          <Text style={styles.partText}>{part.sata_slot}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>LAN</Text>
          <Text style={styles.partText}>{part.lan}</Text>
        </View>
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Wi-Fi</Text>
          <Text style={styles.partText}>{part.wifi}</Text>
        </View>
        <View style={styles.infoContainer}>
