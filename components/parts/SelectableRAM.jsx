...
export default function SelectablePart({ part }) {
  ...
  const handleSelectRAM = (part) => {
    EventEmitter.emit("ramSelected", part);
    router.back();
  };
  ...
  return (
    <View style={styles.part}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.label}>Max clock</Text>
          <Text style={styles.partText}>{part.clock}MHz</Text>
        </View>
      </View>
    </View>
  );
