...
import SelectableRAM from "../../../components/parts/SelectableRAM";
...
export default function RAMScreen() {
  ...
  const [minClock, setMinClock] = useState("");
  const [maxClock, setMaxClock] = useState("");
  ...
  const postRAM = async () => {
    try {
      ...
      const response = await fetch(API_URL + "/rams/filters", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "X-API-KEY": API_KEY,
        ...
        >
          ...
          <View style={[{ width: "100%" }, styles.filterSection]}>
            <TextInput
              ...
              placeholder="Enter a ram brand or model"
              value={nameFilter}
          ...
          <View style={[{ width: "100%" }, styles.advancedFilterSection]}>
            ...
            <View style={styles.advancedForm}>
              ...
              <TextInput
                ...
                value={minClock}
                onChangeText={setMinClock}
                keyboardType="numeric"
                style={[
                  styles.input,
                  focusedInput === "minClock" && {
                    borderColor: Colors.theme.orange,
                  },
                ]}
                onPressIn={() => setFocusedInput("minClock")}
                onEndEditing={() => setFocusedInput(null)}
                placeholderTextColor={
                  focusedInput === "minClock" ? Colors.theme.white : "#ffffff4d"
                }
              />
              <TextInput
                cursorColor={Colors.theme.orange}
                placeholder="Max Clock"
                value={maxClock}
                onChangeText={setMaxClock}
                keyboardType="numeric"
                style={[
                  styles.input,
                  focusedInput === "maxClock" && {
                    borderColor: Colors.theme.orange,
                  },
                ]}
                onPressIn={() => setFocusedInput("maxClock")}
                onEndEditing={() => setFocusedInput(null)}
                placeholderTextColor={
                  focusedInput === "maxClock" ? Colors.theme.white : "#ffffff4d"
                }
              />
              <TextInput
                cursorColor={Colors.theme.orange}
  ...
  function EmptyList() {
    return (
      <View style={styles.emptyContainer}>
        ...
        />
        <Text style={styles.emptyText}>No RAM modules found</Text>
        ...
        {error ? (
          ...
          <>
            <AnimatedFlashList
              ...
              renderItem={({ item }) => <SelectableRAM part={item} />}
          ...
          <View style={styles.loadingContainer}>
            ...
            <Text style={styles.loadingText}>Loading RAM data...</Text>
          </View>
        )}
        <ScrollToTopButton
          scrollY={scrollY}
